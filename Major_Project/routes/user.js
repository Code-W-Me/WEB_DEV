...
const user = require("../models/user.js");
// Route to handle user SIGNUP and  // It creates a new user and logs them in immediately after registration
...
// Route to render the login page and //Used To LOGIN the USER
