 ...
 * @export
 */
export declare const GeocodingLayer: {
...
export type GeocodingLayer = (typeof GeocodingLayer)[keyof typeof GeocodingLayer];
export declare function instanceOfGeocodingLayer(value: any): boolean;
export declare function GeocodingLayerFromJSON(json: any): GeocodingLayer;
export declare function GeocodingLayerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GeocodingLayer;
export declare function GeocodingLayerToJSON(value?: GeocodingLayer | null): any;
export declare function GeocodingLayerToJSONTyped(value: any, ignoreDiscriminator: boolean): GeocodingLayer;
//# sourceMappingURL=GeocodingLayer.d.ts.map